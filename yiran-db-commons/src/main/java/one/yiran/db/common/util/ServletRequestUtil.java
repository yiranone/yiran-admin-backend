...
public class ServletRequestUtil {
    ...
    public static final String HTTP_SERVLET_KEY_LOGIN_TYPE = ServletRequestUtil.class.getName() + "_LOGIN_TYPE";
    public static final String HTTP_SERVLET_KEY_LOGIN_ID = ServletRequestUtil.class.getName() + "_LOGIN_ID";
    public static final String HTTP_SERVLET_KEY_LOGIN_NAME = ServletRequestUtil.class.getName() + "_LOGIN_NAME";
