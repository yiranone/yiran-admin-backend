...
public class AuthInterceptor extends HandlerInterceptorAdapter {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        ...
        request.setAttribute(ServletRequestUtil.HTTP_SERVLET_KEY_LOGIN_ID, session.getUserId());
        request.setAttribute(ServletRequestUtil.HTTP_SERVLET_KEY_LOGIN_TYPE, UserConstants.SESSION_TYPE_USER);
        request.setAttribute(ServletRequestUtil.HTTP_SERVLET_KEY_LOGIN_NAME, session.getLoginName());
        return true;
    }
