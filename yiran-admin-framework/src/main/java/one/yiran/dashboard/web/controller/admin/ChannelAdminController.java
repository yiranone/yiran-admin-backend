...
public class ChannelAdminController {
    ...
    public SysChannel editSave(@ApiObject(validate = true) SysChannel channel) {
        ...
        dbChannel.setH5domainName(channel.getH5domainName());
        dbChannel.setH5logo(channel.getH5logo());
        dbChannel.setRegisterNeedInviteCode(channel.getRegisterNeedInviteCode());
        dbChannel.setOrderNeedInviteCode(channel.getOrderNeedInviteCode());
        dbChannel.setStatus(channel.getStatus());
        dbChannel.setExpireDate(channel.getExpireDate());
        dbChannel.setDigCurrency(channel.getDigCurrency());
        dbChannel.setPayCurrency(channel.getPayCurrency());
        String loginName = SessionContextHelper.getCurrentLoginName();
