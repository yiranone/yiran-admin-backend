...
public class Global {
    ...
    public static String getSalt() {
        ...
        if (StringUtils.isBlank(salt))
            throw BusinessException.build("dashboard.salt not configured yet.");
        return salt;
    }
    ...
    public static String getAvatarPath() {
        ...
        if(StringUtils.isNotBlank(avatar)) {
            if(!avatar.startsWith("/"))
                throw BusinessException.build("dashboard.avatar.filepath need to be configured to start '/'");
            if(!avatar.endsWith("/")) {
                avatar += "/";
            }
            return avatar;
            ...
            if(StringUtils.isBlank(dashPath)) {
                throw BusinessException.build("filepath is not configured!");
            }
            if(!dashPath.startsWith("/"))
                throw BusinessException.build("dashboard.filepath need to be configured to start '/'");
    ...
    public static String getExportPath() {
        ...
        if(StringUtils.isNotBlank(export)) {
            if(!export.startsWith("/"))
                throw BusinessException.build("dashboard.export.filepath need to be configured to start '/'");
            if(!export.endsWith("/")) {
                export += "/";
            }
            return export;
    ...
    public static String getUploadPath() {
        ...
        if(StringUtils.isNotBlank(upload)) {
            if(!upload.startsWith("/"))
                throw BusinessException.build("dashboard.upload.filepath need to be configured to start '/'");
            if(!upload.endsWith("/")) {
                upload += "/";
            }
            return upload;
            ...
            if(!dashPath.startsWith("/"))
                throw BusinessException.build("dashboard.filepathneed to be configured to start '/'");
            if(!dashPath.endsWith("/")) {
                dashPath += "/";
            }
    ...
    public static String getIpV6FilePath() {
        return getConfig("dashboard.ip.filepathV6");
    }
